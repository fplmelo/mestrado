...
# as vezes, ao manipular a arvore, as idades dos nos sao apagadas. Sempre bom salva-las em um arquivo separado para insera-las novamente, se necessario!
branching.times(phylotree2)#idades dos nos
